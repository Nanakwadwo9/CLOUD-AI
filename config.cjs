...
const config = {
  SESSION_ID: process.env.SESSION_ID || "CLOUD-AI~NBBjUDTa#u8eDotFepvqf8YQCfo6EtomhVtHb4Ze5sYeXHzGucag",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "BIIG DHOPE",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "233593412682",
